...
dc_housing_investment %>% 
  ...
  geom_col(mapping = aes(
    x = reorder(str_wrap(incentive_name, 10), -incentive_total_affordable), 
...
dc_housing_investment %>% 
  ...
  labs(
    x = "Investment Program",
    y = "Investment Dollars Per Unit Produced or Preserved"
  ) + 
  coord_flip()

# Todo: make this into a line graph showing investment over time with facets for each program
dc_housing_investment %>% 
